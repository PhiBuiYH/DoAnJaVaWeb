    ...
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <h2>List Brand</h2>
                    <h5>You can edit , add, delete Brand</h5>
                </div>
            </div>
            <!-- /. ROW  -->
            <hr />
                                ...
                                <table class="table table-striped table-bordered table-hover"
                                    ...
                                    <c:forEach items="${brandList}" var="brand">
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a href="<c:url value='/admin/brand/edit?id=${brand.getBrandId() }'/>"
                                                   class="center">Edit</a> |
                                                <a href="<c:url value='/admin/brand/delete?id=${brand.getBrandId()}'/>"
