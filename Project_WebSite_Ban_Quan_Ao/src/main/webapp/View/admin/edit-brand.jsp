    ...
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <h2>Edit Brand</h2>
                    <h5>You can Edit brand's information  in here</h5>
                </div>
            </div>
            <!-- /. ROW  -->
            <hr />
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>Brand:</h3>
                                    <c:url value="/admin/brand/edit" var="edit"></c:url>

                                    <form role="form" action="${edit }" method="post" enctype="multipart/form-data">

                                        <input name="brandid" value="${brandEntity.getBrandId() }" hidden="">
                                        <div class="form-group">
                                            <label>Brand Name:</label> <input class="form-control"
                                                                             value="${brandEntity.getBrandName() }" name="brandname" />
                                        </div>
